                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3>ACTAULIZAR PLATO DE MENU</h3>
                            </div>
                            <div class="card-body">
                                <form method="post" action="Menus">
                                    <%
                                        MenuDao dao = new MenuDao();
                                        int id = Integer.parseInt((String) request.getParameter("idMenu"));
                                        Menu men = (Menu)dao.getById(id);
                                    %>                                
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-xl-6 mb-3">
                                                <div class="example">
                                                    ...
                                                    <input class="form-control" type="text" required="true" name="proNombre" value="<%= men.getMenNombre()%>">
                                                    <input class="form-control" type="hidden" required="true" name="idProducto" value="<%= men.getIdMenu()%>">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 mb-3">
                                                <div class="example">
                                                    <p class="mb-1 text-primary">Codigo:</p>
                                                    <input type="text" class="form-control" required="true" name="proCodigo" value="<%= men.getMenCodigo()%>">
                                                </div>
                                            </div>                                            
                                        </div>                                                                     
                                        <div class="row">                            
                                            <div class="col-xl-6 mb-3">
                                                <div class="example">
                                                    ...
                                                    <input type="number"  class="form-control" maxlength="10"  required="true" name="proStock" value="<%= men.getMenStock()%>">
                                                </div>
                                            </div>      
                                            <div class="col-xl-6 mb-3">
                                                <div class="example">
                                                    <p class="mb-1 text-primary">Precio:</p>
                                                    <input class="form-control" type="decimal" required="true" name="proPrecio" value="<%= men.getMenPrecio()%>">
                                                </div>
                                            </div>
                                        </div>                                                                                                                                                         
                                    </div>
