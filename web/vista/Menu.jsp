                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a href="Menus?accion=crear" class="btn btn-primary text-center">Nuevo Registro</a>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="example" class="display text-center" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <%
                                                                    ...
                                                                    List<Menu> lista = dao.getAll();
                                                                    Iterator<Menu> iterCh = lista.iterator();
                                                                    Menu men = null;
                                            ...
                                            <tr>                                                    
                                                ...
                                                <td class="text-center text-muted"><%= men.getMenCodigo()%></td>                                          
                                                ...
                                                <td class="d-flex justify-content-center text-center gap-2"> 
                                                    <div>
                                                        <a href="Menus?accion=editar&idMenu=<%= men.getIdMenu()%>" class="btn btn-primary">
                                                            Actualizar
                                                        </a>
                                                    </div>
                                                    <div>
                                                        <a href="Menus?accion=eliminar&idMenu=<%= men.getIdMenu()%>" class="btn btn-danger">
                                                            Eliminar
                                                        </a>
                                                    </div>
                                                </td>
