                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a href="Clientes?accion=crear" class="btn btn-primary text-center">Nuevo Registro</a>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>                                                    
                                                ...
                                                <td class="d-flex justify-content-center text-center gap-2"> 
                                                    <div>
                                                        <a href="Clientes?accion=editar&idCliente=<%= cli.getIdCliente()%>" class="btn btn-primary">
                                                            Actualizar
                                                        </a>
                                                    </div>
                                                    <div>
                                                        <a href="Clientes?accion=eliminar&idCliente=<%= cli.getIdCliente()%>" class="btn btn-danger">
                                                            Eliminar
                                                        </a>
                                                    </div>
                                                </td>
